...
module.exports = {
  ...
  author: {
    ...
    name: 'Iris', // 必需
    link: 'https://gitee.com/Iris', // 可选的
  },
  blogger: {
    // 博主信息，显示在首页侧边栏
    avatar: 'img/tx2.jpg',
    name: 'Iris',
    slogan: 'The darkness is no darkness',
  },
  social: {
    // 社交图标，显示于博主信息栏和页脚栏
    ...
    icons: [
      ...
      },
      {
        iconClass: 'icon-git',
        title: 'Github',
        link: 'https://github.com/Iris-6666',
      },
      {
        iconClass: 'icon-gitee',
        title: 'Gitee',
        link: 'https://gitee.com/iris1121',
      },
      {
  ...
  footer: {
    ...
    copyrightInfo:
      'iris | <a href="https://github.com/iris1121" target="_blank">Github repo</a>', 
      // 博客版权信息，支持a标签
  },
